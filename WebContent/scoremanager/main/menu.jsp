			...
			<div class="row text-center px-4 fs-3 my-5">
				...
				<div class="col d-flex align-items-center justify-content-center mx-2 rounded shadow"
					...
					<div>
						<div class="">成績管理</div>
						<div class="">
							<a href="/exam/scoremanager/test/TestRegist.action">成績登録</a>
						</div>
						<div class="">
							<a href="/exam/scoremanager/test/TestList.action">成績参照</a>
						</div>
					</div>
				</div>
				<div class="col d-flex align-items-center justify-content-center mx-2 rounded shadow"
					style="height: 10rem; background-color: #bbd;">
					<a href="/exam/scoremanager/subject/SubjectList.action">科目管理</a>
				</div>
			</div>
		</section>
	</c:param>
